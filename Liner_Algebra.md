...
变换的过程：<br>![空间变换](空间变换.gif)<br>
线性变换就是空间变换的一个特例：<br>![线性变换](线性变换.gif)<br>
而在二维空间中我们需要记录的只是两个基向量的变换过程，其他向量
会随之变换：<br>![二维变换](二维变换.gif)<br>
变换后的线性组合不变：<br>![线性组合变换](线性组合变换.png)<br>
而变换矩阵可以表示我们对空间以及其中的向量具体是如何进行变换的：<br>
![变换矩阵](变换矩阵.png)<br>
上图中矩阵中绿色的第一列，和红色的第二列分别对应二维向量横纵坐标
的变换方式，经过如图所示的运算，我们可以得到变换的后的向量
这也就是我们常见的矩阵乘法：<br>![矩阵乘法](矩阵乘法.png)<br>
更加有趣的是，作者用一个动画来分别描述变换矩阵的两列对两个
基向量，以及整个空间的变换过程：<br>![变换矩阵作用](变换矩阵作用.gif)<br>
...
矩阵来表示这个变换过程：<br>![三维变换](三维变换.png)<br>
...
，纵坐标方向也一样，那么我们就得到的了变换矩阵的值：<br>![点积](点积.png)<br>
ux就是对基向量 i 的变换，uy就是对基向量 j 的变换。我们便找到了点积和矩阵变换之间
的关系：<br>![点积意义](点积意义.png)<br>
